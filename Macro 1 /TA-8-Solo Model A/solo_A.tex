...
\begin{frame}[allowframebreaks]
    ...
    \begin{block}{סימונים מקובלים}
        ...
        \begin{minipage}[t]{0.5\textwidth}
            ...
            \frac{S}{L} &= \frac{sY}{L} = s \cdot y \quad \text{חיסכון לעובד} \\
            \frac{C}{L} &= \frac{(1-s)Y}{L} = (1 - s) \cdot y \quad \text{צריכה לעובד}
            \end{align*}
        \end{minipage}
    \end{block}
...
\begin{frame}
    ...
    \begin{alertblock}{הערה לגבי נגזרת}
        ...
        \begin{equation*}
            \frac{d y}{d t} = \dot y = \frac{d y}{d k } \cdot \frac{d k}{d t} = mpk \cdot \dot k 
        \end{equation*}
