...
\begin{frame}
    ...
    \begin{itemize}
        \item שע''ח נייד מגן על המשק מזעזועים חיצוניים,  $$P^{\ *}\uparrow \implies E \downarrow \implies \frac{\overline{EP^{\ *}}}{P}$$ \\   מגן על פני אינפלציה בחו''ל
        \item שע''ח נייד לא מגן בפני זעזועים פנימיים $$M_0 \downarrow \implies LM \uparrow \implies P \uparrow \implies LM\downarrow$$
        \item שע''ח קבוע לא מגן על המשחק בפני זעזועים חיצוניים, הוא "מייבא אינפלציה מחו''ל" $$P^{\ *}\uparrow \implies P \uparrow \implies \frac{\overline{EP^{\ *}}}{P}$$
        \item שע''ח קבוע מגן מזעזועים פנימיים $$M_0 \downarrow \implies LM \uparrow \implies M^s \downarrow \implies LM \downarrow$$
    \end{itemize}
