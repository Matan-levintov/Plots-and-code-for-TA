...
% ============================================================ %
\title[שע''ח קבוע]{משק פתוח עם שע''ח קבוע באבטלה}
\author{מתן לבינטוב}
...
\begin{frame}
    ...
    \begin{center}
        \begin{tikzpicture}[scale=1.3]
            ...
            % Annotations
            \node at (2,3) {$BP>0$};
            \node at (2,2.6) {\text{תשלומים במאזן עודף}};
            \node at (4.5,1) {$BP<0$};
            \node at (4.5,0.6) {\text{תשלומים במאזן גירעון}};
...
\begin{frame}
    ...
    \begin{center}
        \begin{tikzpicture}[scale=1.4]
            ...
            % Annotations
            \node at (1.5,2.5) {$BP>0$};
            \node at (1.5,2.1) {\text{תשלומים במאזן עודף}};
            \node at (5,1) {$BP<0$};
            \node at (5,0.6) {\text{תשלומים במאזן גירעון}};
